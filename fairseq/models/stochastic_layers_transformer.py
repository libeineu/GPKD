...
@register_model('stochastic_layers_transformer')
class StochasticLayersTransformerModel(FairseqModel):
    """
    ...
    def build_model(cls, args, task):
        ...
        return StochasticLayersTransformerModel(encoder, decoder)
...
@register_model_architecture('stochastic_layers_transformer', 'stochastic_layers_transformer')
...
@register_model_architecture('stochastic_layers_transformer', 'stochastic_layers_transformer_wmt_en_de')
def stochastic_layers_transformer_wmt_en_de(args):
    args.layer_p = 0.2
    args.encoder_layers = 20
    base_architecture(args)


@register_model_architecture('stochastic_layers_transformer', 'stochastic_layers_transformer_t2t_wmt_en_de')
def stochastic_layers_transformer_t2t_wmt_en_de(args):
    args.layer_p = 0.2
...
@register_model_architecture('stochastic_layers_transformer', 'stochastic_layers_relative_transformer_wmt_en_de')
def stochastic_layers_relative_transformer_wmt_en_de(args):
    args.max_relative_length = 8
    args.k_only = True
    base_architecture(args)


@register_model_architecture('stochastic_layers_transformer', 'stochastic_layers_relative_transformer_t2t_wmt_en_de')
def stochastic_layers_relative_transformer_t2t_wmt_en_de(args):
    args.layer_p = 0.2
    args.encoder_normalize_before = True
    args.decoder_normalize_before = True
    args.attention_dropout = getattr(args, 'attention_dropout', 0.1)
